# Legal and Open Source Notice

This project is for educational purposes and integrates several third-party services and open-source tools. It does not claim ownership of any external content or services.

- **Suno Services**: Any music generated with Suno must comply with [Suno's Terms of Service](https://suno.com/terms) and [Privacy Policy](https://suno.com/privacy). Commercial use requires a paid subscription.
- **Bark**: Text-to-audio synthesis uses the open-source [Bark](https://github.com/suno-ai/bark) library (MIT License).
